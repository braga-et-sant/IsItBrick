...
def makeComboWindow():
    ...
    return sg.Window('Add combo', layout, finalize=True, location=(0, 50))
...
def makeCardsWindow():
    ...
    for card in allcards:
        ...
        if(r<6):
            ...
            c+=1
            layout.append([])
    return sg.Window('Add card to combo', layout, finalize=True, location=(0, 50))
def makeTagsWindow():
    layout = []
    layout.append([])
    c = 0
            ...
            if event == 'EXEC':
                ...
                for line in poss.splitlines():
                    if(tmp == 0):
                        ...
                        withht += line.rstrip() + " AND Handtrap\n"
                        withpt += line.rstrip() + " AND Prot\n"
                        withboth += line.rstrip() + " AND Prot AND Handtrap\n"
                #print(cards)
                #print(withht)
